...
const fr: Record<string, string> = {
  ...
  'menu.online': 'En ligne — partie privee',

  // ---- En ligne (src/game/online/)
  ...
  'online.badCode': 'Code trop court.',
  'online.waitingTitle': "En attente de l'adversaire",
  'online.shareCode': 'Donnez ce code a votre adversaire :',
  'online.joining': 'Connexion au salon {code}...',
  'online.cancel': 'Annuler',
  'online.back': 'Retour',
  'online.unsupported': "Ce navigateur ne sait pas faire communiquer deux onglets : la partie en ligne n'est pas disponible ici.",
  'online.yourTurn': 'A vous de jouer',
  'online.opponentTurn': "L'adversaire joue...",
  'online.ended.parti': "L'adversaire a quitte la partie.",
  'online.ended.quitte': 'Vous avez quitte la partie.',
  'online.ended.desynchronise': 'Partie interrompue : un coup ne nous est pas parvenu.',
  'online.ended.incompatible': "Versions du jeu incompatibles : impossible de jouer ensemble.",
  'online.ended.perdu': "Liaison perdue : plus aucun signe de l'adversaire.",
  'online.endedTitle': 'Partie interrompue',
  ...
  'menu.fieldKubbsOnHint':
    "Un kubb abattu est replante dans votre camp : vous devrez l'y abattre une seconde fois, en priorite, avant de viser de nouveau la ligne adverse",
  ...
  'king.or.label': 'Or',
  'king.or.hint': "Le look d'origine, couronne doree",
  'king.argent.label': 'Argent',
  'king.argent.hint': 'Couronne polie et froide (boutique)',
  'king.obsidienne.label': 'Obsidienne',
  'king.obsidienne.hint': 'Verre volcanique sombre, joyaux rouges (boutique)',
  ...
  'baton.boulefer.label': 'Boule de fer',
  'baton.disque.label': 'Disque',
  'baton.plume.label': 'Plume',
  'baton.enclume.label': 'Enclume',
  'baton.fouet.label': 'Fouet',
  ...
  'shop.category.king': 'Skins de roi',
  'shop.owned': 'Possede',
  ...
  'achievement.dans-le-vent.hint': 'Abattre un kubb avec un vent de travers de force 2',
  'achievement.chirurgien.label': 'Chirurgien',
  'achievement.chirurgien.hint': "Gagner une partie sans qu'un seul de vos batons touche une bande",
  'achievement.remontada.label': 'Remontada',
  'achievement.remontada.hint': "Gagner une partie apres n'avoir plus eu qu'un seul kubb debout",
  'achievement.collectionneur.label': 'Collectionneur',
  'achievement.collectionneur.hint': 'Gagner au moins une fois sur chacun des {n} terrains',
  'achievement.increvable.label': 'Increvable',
  'achievement.increvable.hint': 'Terminer les {n} manches du mode Defi',
  ...
  'menu.progressionAria': 'Voir la progression',
  'progression.screenTitle': 'Progression',
  'progression.intro': 'Votre niveau, votre prochain palier, et tout ce qui reste a debloquer.',
  'progression.xpTotal': 'XP totale : {n}',
  'progression.xpToNext': 'Encore {n} XP avant le niveau {level}',
  'progression.statsTitle': 'Statistiques',
  'progression.stat.gamesPlayed': 'Parties jouees : {n}',
  'progression.stat.totalWins': 'Victoires : {n}',
  'progression.stat.winStreak': 'Serie de victoires en cours : {n}',
  'progression.stat.bestStage': 'Meilleure manche Defi : {stage}/{total}',
  'progression.stat.bestStage.none': 'Aucune manche Defi terminee',
  'progression.stat.achievements': 'Succes debloques : {n}/{total}',
  ...
  'perk.oeil-de-lynx.label': 'Oeil de lynx',
  'perk.oeil-de-lynx.description': 'Deviation aleatoire de vos lancers reduite de moitie',
  'perk.sang-froid.label': 'Sang-froid',
  'perk.sang-froid.description': "Effet du vent sur vos lancers reduit de moitie",
  'perk.jauge-basse.label': 'Jauge basse',
  'perk.jauge-basse.description': 'Vos lancers partent toujours a au moins {pct}% de puissance',
  'perk.poigne-ferme.label': 'Poigne ferme',
  'perk.poigne-ferme.description': 'Seuil de chute des kubbs et du roi reduit de {pct}% pour vos coups',
  'perk.bourse-pleine.label': 'Bourse pleine',
  'perk.bourse-pleine.description': '+{pct}% de pieces gagnees sur cette manche',
  'perk.etude-rapide.label': 'Etude rapide',
  'perk.etude-rapide.description': "+{pct}% d'XP gagnee sur cette manche",
  'perk.sursis.label': 'Sursis',
  'perk.sursis.description': "Une fois par run, toucher le roi trop tot ne finit pas la run : la manche est rejouee",
  'perk.longue-haleine.label': 'Longue haleine',
  'perk.longue-haleine.description': '+{s} secondes sur l\'horloge de cette manche',
  'perk.renfort.label': 'Renfort',
  'perk.renfort.description': 'Un kubb adverse au hasard est deja abattu avant votre premier lancer',
  'perk.calme-plat.label': 'Calme plat',
  'perk.calme-plat.description': "La meteo est desactivee pour cette manche, si elle etait active",
  ...
  'match.sursis': 'SURSIS ! MANCHE REJOUEE',
...
const en: Record<string, string> = {
  ...
  'menu.online': 'Online — private match',
  ...
  'online.badCode': 'Code too short.',
  'online.waitingTitle': 'Waiting for your opponent',
  'online.shareCode': 'Give this code to your opponent:',
  'online.joining': 'Connecting to room {code}...',
  'online.cancel': 'Cancel',
  'online.back': 'Back',
  'online.unsupported': 'This browser cannot link two tabs: online play is unavailable here.',
  'online.yourTurn': 'Your turn',
  'online.opponentTurn': 'Opponent is playing...',
  'online.ended.parti': 'Your opponent left the match.',
  'online.ended.quitte': 'You left the match.',
  'online.ended.desynchronise': 'Match interrupted: a throw never reached us.',
  'online.ended.incompatible': 'Incompatible game versions: you cannot play together.',
  'online.ended.perdu': 'Connection lost: no sign of your opponent.',
  'online.endedTitle': 'Match interrupted',
  ...
  'menu.fieldKubbsOnHint':
    'A knocked-down kubb is replanted in your half: you must knock it down a second time, as a priority, before aiming at the opposing baseline again',
  ...
  'king.or.label': 'Gold',
  'king.or.hint': 'The original look, golden crown',
  'king.argent.label': 'Silver',
  'king.argent.hint': 'Polished, cold-toned crown (shop)',
  'king.obsidienne.label': 'Obsidian',
  'king.obsidienne.hint': 'Dark volcanic glass, red gems (shop)',
  ...
  'baton.boulefer.label': 'Iron ball',
  'baton.disque.label': 'Disc',
  'baton.plume.label': 'Feather',
  'baton.enclume.label': 'Anvil',
  'baton.fouet.label': 'Whip',
  ...
  'achievement.dans-le-vent.hint': 'Knock a kubb down in a force-2 crosswind',
  'achievement.chirurgien.label': 'Surgeon',
  'achievement.chirurgien.hint': 'Win a match without a single one of your batons touching a wall',
  'achievement.remontada.label': 'Comeback',
  'achievement.remontada.hint': 'Win a match after being down to a single standing kubb',
  'achievement.collectionneur.label': 'Collector',
  'achievement.collectionneur.hint': 'Win at least once on each of the {n} fields',
  'achievement.increvable.label': 'Unstoppable',
  'achievement.increvable.hint': 'Clear all {n} stages of Challenge mode',
  ...
  'menu.progressionAria': 'View progression',
  'progression.screenTitle': 'Progression',
  'progression.intro': 'Your level, your next milestone, and everything left to unlock.',
  'progression.xpTotal': 'Total XP: {n}',
  'progression.xpToNext': '{n} XP to go until level {level}',
  'progression.statsTitle': 'Statistics',
  'progression.stat.gamesPlayed': 'Games played: {n}',
  'progression.stat.totalWins': 'Wins: {n}',
  'progression.stat.winStreak': 'Current win streak: {n}',
  'progression.stat.bestStage': 'Best Challenge stage: {stage}/{total}',
  'progression.stat.bestStage.none': 'No Challenge stage cleared yet',
  'progression.stat.achievements': 'Achievements unlocked: {n}/{total}',
  ...
  'perk.oeil-de-lynx.label': 'Eagle eye',
  'perk.oeil-de-lynx.description': 'Random deviation of your throws halved',
  'perk.sang-froid.label': 'Cool head',
  'perk.sang-froid.description': 'Wind effect on your throws halved',
  'perk.jauge-basse.label': 'Low gauge',
  'perk.jauge-basse.description': 'Your throws always start at least {pct}% power',
  'perk.poigne-ferme.label': 'Firm grip',
  'perk.poigne-ferme.description': 'Knockdown threshold for kubbs and the king reduced by {pct}% for your hits',
  'perk.bourse-pleine.label': 'Full purse',
  'perk.bourse-pleine.description': '+{pct}% coins earned this stage',
  'perk.etude-rapide.label': 'Quick study',
  'perk.etude-rapide.description': '+{pct}% XP earned this stage',
  'perk.sursis.label': 'Reprieve',
  'perk.sursis.description': "Once per run, hitting the king too soon doesn't end the run — the stage is replayed",
  'perk.longue-haleine.label': 'Stamina',
  'perk.longue-haleine.description': '+{s} seconds on this stage\'s clock',
  'perk.renfort.label': 'Reinforcement',
  'perk.renfort.description': 'A random opponent kubb is already down before your first throw',
  'perk.calme-plat.label': 'Dead calm',
  'perk.calme-plat.description': 'Weather is disabled for this stage, if it was active',
  ...
  'match.sursis': 'REPRIEVE! STAGE REPLAYED',
