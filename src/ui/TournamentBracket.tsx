...
import { champion, nextMatch, roundLabel } from '../game/tournament';
  ...
  return (
    <div className="overlay overlay--solid">
      <div className="panel panel--scroll">
        <h2 className="panel__title">Tournoi</h2>

        {tournament.rounds.map((round, r) => (
          <div key={r} style={{ marginBottom: 16 }}>
            <h3 className="bracket__round-title">{roundLabel(r, tournament.rounds.length)}</h3>
